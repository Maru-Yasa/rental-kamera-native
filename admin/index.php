        ...
        <div class="row">
            ...
            <div class="col-sm p-3 min-vh-100 row justify-content-center">
               <div class="col-12 row justify-content-center">
                  <h1 class="text-dark mx-3">Dashboard</h1>
                  <div class="mt-1 col-10 row justify-content-center" style="height: 150px;">
                     <div class="card bg-dark col-3 mx-1">
                        <div class="card-body row">
                           ...
                           <div class="col-6">
                                 <i class="bi bi-grid text-white d-block right" style="font-size:60px;opacity:50%;"></i>
                           </div>
                        </div>
                     </div>
                     <div class="card bg-dark col-3 mx-1">
                        <div class="card-body row">
                           ...
                           <div class="col-6">
                                 <i class="bi bi-table text-white d-block right" style="font-size:60px;opacity:50%;"></i>
                           </div>
                        </div>
                     </div>
                     <div class="card bg-dark col-3 mx-1">
                        <div class="card-body row">
                           ...
                           <div class="col-6">
                              <i class="bi bi-people text-white d-block right" style="font-size:60px;opacity:50%;"></i>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="text-center">
                     <i class="bi bi-person-circle text-dark" style="font-size: 70px;"></i>
                     <br>
                     <span class="fs-3 mb-2">
                        Halo, <?= $_SESSION['user']['username'] ?>
                     </span>
                     <br>
                     <a class="btn btn-sm btn-outline-dark" href="/admin/edit_profile.php?id=<?= $_SESSION['user']['id'] ?>"> <i class="bi bi-pencil-fill"></i> Edit profile</a>
                  </div>
               </div>
            </div>
        </div>
