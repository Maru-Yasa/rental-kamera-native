<div class="col-sm-auto bg-dark text-white sticky-top shadow">
                <div class="d-flex flex-sm-column flex-row flex-nowrap bg-dark text-white align-items-center sticky-top">
                    <a href="/" class="d-block p-3 link-dark text-decoration-none" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
                        <i class="bi-camera-fill text-white fs-1"></i>
                    </a>
                    <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
                        <li class="nav-item">
                            <a href="/admin" class="nav-link py-3 px-2" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Home">
                                <i class="bi-speedometer text-white fs-4"></i>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/orders.php" class="nav-link py-3 px-2" title="Orders" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Orders">
                                <i class="bi-table fs-4 text-white"></i>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/devices.php" class="nav-link py-3 px-2" title="Devices" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Customers">
                                <i class="bi-grid-fill text-white fs-4"></i>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/users.php" class="nav-link py-3 px-2" title="Users" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Customers">
                                <i class="bi-people-fill text-white fs-4"></i>
                            </a>
                        </li>
                    </ul>
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center justify-content-center p-3 link-light text-decoration-none dropdown-toggle" id="dropdownUser3" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi-person-circle text-white text-primary fs-4"></i>
                        </a>
